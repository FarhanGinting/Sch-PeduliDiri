                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('catatan.update', $catatan->id) }}" class="row g-3 " enctype="multipart/form-data">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="nama" class="form-control" id="nama" value="{{ $catatan->nama }}" required>

                            </div>

                            <div class="col-12">
                                <label class="form-label">Tanggal</label>
                                <input type="date" name="tanggal" class="form-control" id="tanggal" value="{{ $catatan->tanggal }}" required>
                            </div>

                            <div class="col-12">
                                <label class="form-label">Waktu</label>
                                <input type="time" name="waktu" class="form-control" id="waktu" value="{{ $catatan->waktu }}" required>
                            </div>
                            ...
                            <div class="d-flex justify-content-center column-gap-4 mt-5 mb-4">
                                <a href="/details/{{ $catatan->id }}/{{ $catatan->nama }}" class="btn btn-secondary" style="float: right;">Kembali</a>
